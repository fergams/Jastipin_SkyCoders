    ...
    <div className="homepage">
      ...
      <header className="khat d-flex align-items-center">
        <Container>
          ...
          <Row className="header-box align-center fw-bold mb-4 color-blue">
            <h5> Jastip.in</h5>
          </Row>
          <div></div>
          <div></div>
            ...
            <div class="ui items">
              <div class="item">
                ...
                <div class="content mt-4">
                  <div class="header">Croissant Arab Saudi</div>
                  <div class="meta">
                    <span class="price">Variant Creamy Chocolate and Creamy Cheese</span>
                  </div>
            ...
            <div class="ui items">
              <div class="item">
                ...
                <div class="content mt-4">
                  ...
                  <div class="meta">
                    <span class="price">
                      <Icon name="map marker" className="" />
                      KOTA BATAM
                    </span>
                  </div>
