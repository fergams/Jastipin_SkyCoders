        ...
        <div className="profile d-flex">
            ...
            <div className="content ">
              ...
              <div className="navbarstatus d-flex" style={{backgroundColor:'#D7E3F6',height:'40px', width:'850px',borderRadius:'10px', marginTop:'2%'}}>
                ...
                <p onClick={() => navigate("/Selesai")} style={{color:'#0081c9', cursor:'pointer'}}>Selesai</p>
              ...
              <div className="main" style={{backgroundColor:'#d7e3f6', borderRadius:'10px', marginTop:'2%', width:'93%', paddingBottom:'20px'}}>
                ...
                <button class="Bayar" onClick={() => navigate("/RatingUlasan")} style={{marginLeft:'660px',marginTop:'10px' ,padding:'10px 30px', borderRadius:'5px', backgroundColor:'#0081c9', border:'none', color:'white'}}>Beri Ulasan</button>
              </div>
